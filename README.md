...
![logo](https://github.com/seelifeasdata/pets_classification/blob/main/images/logo.gif)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/gradio.png)
...
### Dog and Cat Breeds in the dataset
 ...
 ![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/dataset_stats.png)

### Annotation Examples from the dataset

 ![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/annotation_examples.png)
...
```
 ![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/sample_cat.jpg)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/segmask-1.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/hist.gif)

![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/otsu-2.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/motsu-1.png)
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/motsu-2.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/motsu-3.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/segmask-tf-1.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/unet.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/params.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/epochs.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/predmask-1.png)
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/predmask-2.png)
...
![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/fastai-1.png)

- Model Training with  **resnet34** function from fastai library
	- fine tuning with 3 epochs. We get the following error rates
	
	![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/er1.png)
...
- Next we train with a different model from the timm library - **'convnext_tiny_in22k'**
	...
	![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/er2.png)
	
- Evaluation of the classifier 
	- with a basset hound breed of dog
	
	![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/basset.png)
	
	- prediction as below
	
	![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/99.png)
...
- Building a Gradio Application and hosting it on Huggingface/Spaces
	...
	```
- [Breed Classifier application](https://huggingface.co/spaces/vasanthgx/oxford_pets_breed_classification)

	![alt text](https://github.com/seelifeasdata/pets_classification/blob/main/images/gradio3.png)
